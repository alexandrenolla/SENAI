...
function calcularSalario() {
    ...
    var resultado = salario - inss - impostoDeRenda - fgts
    ...
    var porcentagemFgtsTabela = document.getElementById("porcentagemFgts")
    porcentagemFgtsTabela.innerHTML = porcentagemFgts
    var fgtsTabela = document.getElementById('valorDescontadoFgts')
    fgtsTabela.innerHTML = fgts

    var resultadoSalario = document.getElementById("resultado")
    resultadoSalario.innerHTML = resultado
