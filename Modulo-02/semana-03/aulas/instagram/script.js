...
function carregarPosts() {
    ...
    posts.forEach(function (post) {
        ...
        */
        ...
        post.comentarios.forEach(function(index) {
            
           /* var comentarioAutour = document.createElement('li')
            comentarioAutor.innerHTML = index.comentarioAutor
            listaComentarios.appendChild(comentarioAutor) */
            
            var comentario = document.createElement('li')
            comentario.innerHTML = index.comentario
